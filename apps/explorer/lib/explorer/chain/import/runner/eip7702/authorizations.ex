defmodule Explorer.Chain.Import.Runner.Eip7702.Authorizations do
  @moduledoc """
  Bulk imports `t:Explorer.Chain.Eip7702.Authorization.t/0`.
  """
  ...
  defp default_on_conflict do
    from(
      ...
      where:
        fragment(
          "(EXCLUDED.chain_id, EXCLUDED.address, EXCLUDED.nonce, EXCLUDED.r, EXCLUDED.s, EXCLUDED.y_parity) IS DISTINCT FROM (?, ?, ?, ?, ?, ?)",
